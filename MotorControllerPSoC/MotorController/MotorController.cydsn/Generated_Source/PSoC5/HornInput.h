...
void    HornInput_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the HornInput_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(HornInput__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in HornInput_SetInterruptMode() function.
     *  @{
     */
        #define HornInput_INTR_NONE      (uint16)(0x0000u)
        #define HornInput_INTR_RISING    (uint16)(0x0001u)
        #define HornInput_INTR_FALLING   (uint16)(0x0002u)
        #define HornInput_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define HornInput_INTR_MASK      (0x01u) 
#endif /* (HornInput__INTSTAT) */
...
/* SIO registers */
#if defined(HornInput__SIO_CFG)
    #define HornInput_SIO_HYST_EN        (* (reg8 *) HornInput__SIO_HYST_EN)
    #define HornInput_SIO_REG_HIFREQ     (* (reg8 *) HornInput__SIO_REG_HIFREQ)
    #define HornInput_SIO_CFG            (* (reg8 *) HornInput__SIO_CFG)
    #define HornInput_SIO_DIFF           (* (reg8 *) HornInput__SIO_DIFF)
#endif /* (HornInput__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define HornInput_0_INTTYPE_REG 		(* (reg8 *) HornInput__0__INTTYPE)
#endif /* (HornInput__INTSTAT) */
