// ======================================================================
// Speedometer.v generated from TopDesign.cysch
// 04/18/2016 at 21:15
...
module top ;
    ...
    Timer_v2_70_0 Timer_Speedometer (
        .reset(Net_223),
        .interrupt(Net_172),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_247),
        .clock(Net_130));
    defparam Timer_Speedometer.CaptureCount = 2;
    defparam Timer_Speedometer.CaptureCounterEnabled = 0;
    defparam Timer_Speedometer.DeviceFamily = "PSoC5";
    defparam Timer_Speedometer.InterruptOnCapture = 0;
    defparam Timer_Speedometer.InterruptOnTC = 1;
    defparam Timer_Speedometer.Resolution = 16;
    defparam Timer_Speedometer.SiliconRevision = "0";

	wire [0:0] tmpOE__Pin_Speedometer_net;
	wire [0:0] tmpIO_0__Pin_Speedometer_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Speedometer_net;
	electrical [0:0] tmpSIOVREF__Pin_Speedometer_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_Speedometer
		 (.oe(tmpOE__Pin_Speedometer_net),
		  .y({1'b0}),
		  .fb({Net_223}),
		  .io({tmpIO_0__Pin_Speedometer_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Speedometer_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Speedometer_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Speedometer_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    USBFS_v2_70_1 USBUART_1 (
        .sof(Net_27),
        .vbusdet(1'b0));
