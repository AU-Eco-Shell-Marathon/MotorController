...
void CAN_1_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_1_ReceiveMsgCAN_STATUS
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_1_ReceiveMsgCAN_STATUS(void) 
    {
        /* `#START MESSAGE_CAN_STATUS_RECEIVED` */
        CAN_func(CAN_1_GET_DLC(CAN_1_RX_MAILBOX_CAN_STATUS), CAN_STATUS);
        /* `#END` */

        #ifdef CAN_1_RECEIVE_MSG_CAN_STATUS_CALLBACK
            CAN_1_ReceiveMsg_CAN_STATUS_Callback();
        #endif /* CAN_1_RECEIVE_MSG_CAN_STATUS_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:    CAN_1_ReceiveMsgBATTERY_V
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_1_ReceiveMsgBATTERY_V(void) 
    {
        /* `#START MESSAGE_BATTERY_V_RECEIVED` */
        CAN_func(CAN_1_GET_DLC(CAN_1_RX_MAILBOX_BATTERY_V), BATTERY_V);
        /* `#END` */

        #ifdef CAN_1_RECEIVE_MSG_BATTERY_V_CALLBACK
            CAN_1_ReceiveMsg_BATTERY_V_Callback();
        #endif /* CAN_1_RECEIVE_MSG_BATTERY_V_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_1_ReceiveMsgBATTERY_A
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_1_ReceiveMsgBATTERY_A(void) 
    {
        /* `#START MESSAGE_BATTERY_A_RECEIVED` */
        CAN_func(CAN_1_GET_DLC(CAN_1_RX_MAILBOX_BATTERY_A), BATTERY_A);
        /* `#END` */

        #ifdef CAN_1_RECEIVE_MSG_BATTERY_A_CALLBACK
            CAN_1_ReceiveMsg_BATTERY_A_Callback();
        #endif /* CAN_1_RECEIVE_MSG_BATTERY_A_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_1_ReceiveMsgDOD
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        /* `#START MESSAGE_DOD_RECEIVED` */
        CAN_func(CAN_1_GET_DLC(CAN_1_RX_MAILBOX_DOD), DOD);
        /* `#END` */

        #ifdef CAN_1_RECEIVE_MSG_DOD_CALLBACK
            CAN_1_ReceiveMsg_DOD_Callback();
        #endif /* CAN_1_RECEIVE_MSG_DOD_CALLBACK */
