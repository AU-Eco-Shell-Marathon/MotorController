...
#if !defined(CY_Timer_v2_60_Timer_speed_H)
#define CY_Timer_v2_60_Timer_speed_H
...
#define Timer_speed_UsingFixedFunction         0u
...
#define Timer_speed_INIT_PERIOD             65535u
#define Timer_speed_INIT_CAPTURE_MODE       ((uint8)((uint8)1u << Timer_speed_CTRL_CAP_MODE_SHIFT))
#define Timer_speed_INIT_TRIGGER_MODE       ((uint8)((uint8)0u << Timer_speed_CTRL_TRIG_MODE_SHIFT))
#if (Timer_speed_UsingFixedFunction)
    #define Timer_speed_INIT_INTERRUPT_MODE (((uint8)((uint8)1u << Timer_speed_STATUS_TC_INT_MASK_SHIFT)) | \
...
#endif  /* CY_Timer_v2_30_Timer_speed_H */
